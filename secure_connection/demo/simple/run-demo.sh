...
echo -e "${BLUE}======================================${NC}"
echo -e "${BLUE}TPM Session Encryption Demo${NC}"
echo -e "${BLUE}======================================${NC}"
echo ""
...
echo -e "3. Look for TPM2_CreatePrimary commands (0x00000131)"
echo -e "4. Compare InSensitive parameters:"
echo -e "   ${RED}• plaintext.cap${NC}  - Password visible as ASCII text"
echo -e "   ${GREEN}• encrypted.cap${NC} - Password encrypted, unreadable"
echo ""
echo -e "To analyze with tpm2-tss-tools:"
echo -e "  tshark -r $(dirname "$0")/plaintext.cap -Y tpm -V | grep -A20 CreatePrimary"
echo -e "  tshark -r $(dirname "$0")/encrypted.cap -Y tpm -V | grep -A20 CreatePrimary"
echo ""
